                        ...
                        <div class="card">
                            <div class="card-body px-3 py-3-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">activité de l'utilisateur</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-3 py-3-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">total d'utilisateurs</h6>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{url('/annonce')}}"> <i class="bi bi-bell"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">Notifications   ({{count(auth()->user()->unreadNotifications)}})</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="stats-icon blue">
                                           <a href="{{url('/ensajchat')}}"><h3><i class="bi bi-chat"></i></h3></a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">Ensaj Messenger</h6>
